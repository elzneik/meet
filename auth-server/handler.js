...
const credentials = {
  ...
  redirect_uris: ["https://elzneik.github.io/meet"],
  javascript_origins: ["https://elzneik.github.io", "http://localhost:3000"],
};
...
// Step 2 for autorization with OAuth2 - Get Token
// Therefore: use code from first step to genrate access token
